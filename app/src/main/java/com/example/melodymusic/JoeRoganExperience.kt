...
class JoeRoganExperience : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_joe_rogan_experience)
        ...
        mediaPlayer = MediaPlayer.create(this,R.raw.joeroganexperience)
