...
class IndianBusinessPodcast : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_indian_business_podcast)
        ...
        mediaPlayer = MediaPlayer.create(this,R.raw.indianbusinesspodcast)
